...
public final class SafariWeb {
    ...
    public static class Builder {
        ...
        /**
         *
         * @param title Specifies the title to be set for the Safari Push
         * Notifications.
        ...
        /**
         *
         * @param urlArgs The URL arguments that need to be used with this
         * notification. This has to provided in the form of a JSON Array.
         * @return The Builder object for calls to be linked.
         */
