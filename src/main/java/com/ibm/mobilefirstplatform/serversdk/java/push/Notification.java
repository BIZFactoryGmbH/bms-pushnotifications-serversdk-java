...
public class Notification {
    ...
    public static class Builder {
         ...
         *
         * @param message The object that is set with all message attributes.
         *
         ...
         *
         * @param target The object that is set with all target attributes.
         *
         * @return The NotificationBuilder object for calls to be linked.
         */
         ...
         *
         * @param settings The object that is set with all settings attributes.
         *
         * @return The NotificationBuilder object for calls to be linked.
         */
