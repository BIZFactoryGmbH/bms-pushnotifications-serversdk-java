...
public final class Settings {
    ...
    public static class Builder {
        ...
        /**
         *
         * @param apns APNs object with optional settings.
        ...
        /**
         *
         * @param fcm FCM object with optional settings.
         * @return The Builder object for calls to be linked.
         */
        ...
        /**
         *
         * @param firefoxWeb FirefoxWeb object with optional settings.
         * @return The Builder object for calls to be linked.
         */
        ...
        /**
         *
         * @param chromeWeb ChromeWeb object with optional settings.
         * @return The Builder object for calls to be linked.
         */
        ...
        /**
         *
         * @param safariWeb SafariWeb object with optional settings.
         * @return The Builder object for calls to be linked.
         */
        ...
        /**
         *
         * @param chromeAppExt ChromeAppExtension object with optional settings.
         * @return The Builder object for calls to be linked.
         */
